...
export const createOrdenVentaRouter = (OrdenVentaModel, OrdenVentaSchema) => {
     ...
     ordenVentaRouter.post('/create', ordenVentaController.create);

     ordenVentaRouter.post('/getBy', ordenVentaController.getBy);

     ordenVentaRouter.post('/delete', ordenVentaController.delete);

     ordenVentaRouter.post('/update', ordenVentaController.update);
