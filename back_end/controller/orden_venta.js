    ...
    update = async (req, res) => {
        ...
        try {
            ...
            for (const nuevo of articulosActualizados) {
                ...
                if (!existente) {
                    ...
                    if (
                        ...
                        existente.nombre_articulo !== nuevo.nombre_articulo
                    ) {
            ...
            return res.status(200).json({
                type: "success",
                message:
                    "Orden de venta y artículos actualizados correctamente.",
            });
        } catch (error) {
            res.status(500).json({
                type: "error",
